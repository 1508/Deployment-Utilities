...
if not exist "%VS120COMNTOOLS%" goto MissingCOMNTOOLS
...
MSBuild.exe %1
start "" "%VS120COMNTOOLS%..\IDE\devenv.exe" %1
GOTO:EOF

:MissingCOMNTOOLS
echo Visual studio default location was not found...
echo Script terminated: %VS120COMNTOOLS% does not exist
pause
GOTO:EOF
...
echo Example: call "\\QA\utilities\deployment\VS2013.build.bat" "D:\web\selco.com\website\selco.sln"
pause
GOTO:EOF
...
echo.   
echo    VS2013.build.cmd [solution filepath]
GOTO:EOF