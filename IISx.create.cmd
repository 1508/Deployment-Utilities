...
echo.
echo    HOSTHEADER           Can be comma separated but only IIS7 will interpret this. IIS6 will create separate websites for each hostheader
echo    managedPipelineMode  Used by IIS7, default is classic but "Integrated" can be set for the website app pool.
echo.
echo  Example:
